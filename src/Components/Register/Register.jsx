    ...
    return (
        <div className='py-5 container'>
            ...
            <form onSubmit={submitForm}>
                ...
                { errorList.map((error, index) => <li key={index} className="text-danger" > {error.path === 'password' && error.type !== "string.empty" ? "Starting with the letter SMALL, then a number" : error.message}</li>)}
